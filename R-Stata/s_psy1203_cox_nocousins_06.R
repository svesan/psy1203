#-----------------------------------------------------------------------------
# Study.......: PSY1203
# Name........: s_psy1203_cox_nocousins_05.R
# Date........: 2013-05-23
# Author......: svesan
...
save(cis.asd, file="psy1203_estimates_nocousins_asd_B.RData", compress=T)
save(asd.list, cis.asd, file="psy1203_results_nocousins_asd_B.RData", compress=T)
...
save(cis.ad, file="psy1203_estimates_nocousins_ad_B.RData", compress=T)
save(ad.list, cis.ad, file="psy1203_results_nocousins_ad_B.RData", compress=T)

#-- Output the results
sink("s_psy1203_cox_nocousins_05_AD.txt", split=T, append=FALSE)
