  ...
  select lopnr length=6, diagnos length=4, diag_nr length=3, icd_nr length=3,
     ...
     where a.diag_nr<23
           and ((a.icd_nr=7 and substr(a.diagnos,1,3) in ('300','301','302','309') ) or
                (a.icd_nr=8 and substr(a.diagnos,1,3) in ('295','296','297','298','299')  )
                (a.icd_nr=9 and substr(a.diagnos,1,3) in ('295','296','297','298','299','300') )or
                (a.icd_nr=10 and substr(a.diagnos,1,3)='F20','F21','F22','F23','F24','F25','F28','F29','F20','F20','F20','F20',) ) or
