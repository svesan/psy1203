...
proc gdevice nofs catalog=gdevice0.devices;
  copy zpslepsf from=sashelp.devices newname=eps14x12;
  modify eps14x12
...
;
  ...
  copy zpslepsf from=sashelp.devices newname=eps13x12;
  modify eps13x12
...
;
  ...
  copy zpslepsf from=sashelp.devices newname=eps20x16;
  modify eps20x16
...
;
  ...
  copy zpslepsf from=sashelp.devices newname=eps14x16;
   modify eps14x16
    description='14*16 (x*y) cm gray EPS'
     hsize  =13.75cm  vsize  = 15.70cm
     horigin= 0.25cm  vorigin=  0.25cm
     xmax   =14.00cm  ymax   = 16.00cm
